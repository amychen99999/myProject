            ...
            AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent,
                    ...
                    switch ((int)(Math.random()*4 + 1)) {
                        case 1:
                            mImgSwitcher.setOutAnimation(anim.alphaOut());
                            mImgSwitcher.setInAnimation(anim.alphaIn());
...
//                                    R.anim.alpha_out));
                            break;
                        case 2:
                            mImgSwitcher.setOutAnimation(anim.transOut());
                            mImgSwitcher.setInAnimation(anim.transIn());
//                            mImgSwitcher.setInAnimation(AnimationUtils.loadAnimation(MainActivity.this,
//                                    R.anim.trans_in));
//                            mImgSwitcher.setOutAnimation(AnimationUtils.loadAnimation(MainActivity.this,
//                                    R.anim.trans_out));
                            break;
                        case 3:
                            mImgSwitcher.setOutAnimation(anim.scaleRotateOut());
                            mImgSwitcher.setInAnimation(anim.scaleRotateIn());
//                            mImgSwitcher.setInAnimation(AnimationUtils.loadAnimation(MainActivity.this,
...
//                                    R.anim.scale_rotate_out));
                            break;
                        case 4:
                            mImgSwitcher.setOutAnimation(anim.scaleRotaeTransOut());
                            mImgSwitcher.setInAnimation(anim.scaleRotaeTransIn());
//                            mImgSwitcher.setInAnimation(AnimationUtils.loadAnimation(MainActivity.this,
